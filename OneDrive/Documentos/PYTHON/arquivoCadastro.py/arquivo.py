...
def registrar_visitante():
    while True:
        ...
        if nome.isalpha():
            print("O nome tem que ser completo. Tente novamente.")
            continue

        idade = input("Digite a idade do visitante: ")
        documento = input("Digite o número do CPF de identificação do visitante: ")
        if len(documento) != 11:
            print("O número do CPF de identificação deve conter 11 dígitos. Tente novamente.")
            continue
...
def preencher_dados():
    ...
    print("O número do documento de identificação deve conter 11 dígitos.")
